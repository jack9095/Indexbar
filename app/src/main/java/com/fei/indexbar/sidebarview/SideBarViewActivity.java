package com.fei.indexbar.sidebarview;
...
import com.fei.indexbar.databinding.ActivityBarViewBinding;
import com.fei.indexbar.sidebarview.adapter.PhoneAreaAdapter;
import com.fei.indexbar.sidebarview.bean.AreaPhoneBean;
import com.fei.indexbar.sidebarview.utils.PinyinUtils;
import com.fei.indexbar.sidebarview.utils.ReadAssetsJsonUtil;
import com.fei.sidebarview.SideBar;
...
public class SideBarViewActivity extends AppCompatActivity {

    private ArrayList<AreaPhoneBean> mBeans = new ArrayList<>();

    private ActivityBarViewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityBarViewBinding.inflate(getLayoutInflater());
