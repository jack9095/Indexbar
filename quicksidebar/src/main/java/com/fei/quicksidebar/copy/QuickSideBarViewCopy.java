 ...
 * Letter 字母的意思
 */
public class QuickSideBarViewCopy extends View {
    ...
    public QuickSideBarViewCopy(Context context) {
        this(context, null);
    }

    public QuickSideBarViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QuickSideBarViewCopy(Context context, AttributeSet attrs, int defStyle) {
